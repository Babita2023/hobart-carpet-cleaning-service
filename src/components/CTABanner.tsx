  ...
  <section className="py-14 cta-gradient">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <Button variant="outline" size="lg" className="text-base border-accent-foreground/30 text-accent-foreground hover:bg-accent-foreground/10" asChild>
          <a href="tel:0362001234"><Phone className="w-5 h-5 mr-2" /> Call (03) 6200 1234</a>
        </Button>
      </div>
    </div>
  </section>
